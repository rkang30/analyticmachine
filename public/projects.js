...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clients = (function (_React$Component) {
		...
		_createClass(Clients, [{
			...
			value: function updateProjectList(event) {
				this.setState({
			...
			value: function render() {
				...
				var filteredProjects = this.state.projects.filter(function (project) {
					if (project.name.toLowerCase().indexOf(_this.state.search.toLowerCase()) !== -1) {
						return true;
					} else {
						return false;
					}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement('input', { type: 'text', className: 'form-control', id: 'project_search', onChange: this.updateProjectList.bind(this), value: this.state.search, placeholder: 'Search' })
					),
					_react2['default'].createElement(
						'ul',
						{ className: 'list-group' },
						filteredProjects.map(function (project) {
							var projectLink = '/projects/detail/' + project.slug;
							return _react2['default'].createElement(
								'li',
								{ className: 'list-group-item', key: project.id },
								_react2['default'].createElement(
									'a',
									{ href: projectLink },
									project.name
	...
	_reactDom2['default'].render(_react2['default'].createElement(Clients, { source: 'http://analyticmachine.com/projects/lists' }), document.getElementById('project_list'));
