...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ClientLists = __webpack_require__(159);

	var _ClientLists2 = _interopRequireDefault(_ClientLists);

	var _jquery = __webpack_require__(161);

	var _jquery2 = _interopRequireDefault(_jquery);

	var sourcedata = window.location.href + '/data';
	...
	var Clients = (function (_React$Component) {
		...
		function Clients() {
			...
			_get(Object.getPrototypeOf(Clients.prototype), 'constructor', this).call(this);
			this.state = {
				contacts: [],
				category: '',
				search: '',
		...
		_createClass(Clients, [{
			...
			value: function componentDidMount() {
				...
				this.serverRequest = _jquery2['default'].ajax({
					...
					success: (function (result) {
						...
						var sortKey = '';
						_jquery2['default'].each(result[0], function (i, v) {
			...
			key: 'updateHeader',
			value: function updateHeader(event) {
				var cat = (0, _jquery2['default'])("#category option:selected").val();
			...
			key: 'updateLists',
			value: function updateLists(event) {
				this.setState({
			...
			value: function render() {
	   		...
	   		console.log(url);*/
				...
				var filteredContacts = this.state.contacts.filter(function (contact) {
					var cat = _this.state.category;

					if (cat == '') {
						var num = 0;
						_jquery2['default'].each(_this.state.contacts[0], function (i, v) {
					...
					if (contact[cat].toLowerCase().indexOf(_this.state.search.toLowerCase()) !== -1) {
						return true;
					} else {
						return false;
					}
				...
				var headers = [];
				_jquery2['default'].each(Contacts, function (i, v) {
					if (i == 0) {
						var count = 1;
						_jquery2['default'].each(v, function (k, l) {
				...
				var selected = this.state.marked;
				var disabled = '';
				if (selected == '') {
					disabled = 'disabled';
				} else {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'select',
							{ id: 'category', className: 'form-control', onChange: this.updateHeader.bind(this) },
							_react2['default'].createElement(
								'option',
								{ value: '' },
								'select one'
					...
					_react2['default'].createElement(
						'fieldset',
						{ className: 'form-group' },
						_react2['default'].createElement('input', { type: 'text', className: 'form-control', name: 'search', id: 'search', onChange: this.updateLists.bind(this), disabled: disabled, value: this.state.search, placeholder: 'Enter Your Search' })
					),
					_react2['default'].createElement(_ClientLists2['default'], { contacts: filteredContacts, headers: headers })
				);
			}
		}]);
	...
	_reactDom2['default'].render(_react2['default'].createElement(Clients, { source: sourcedata }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientLists = (function (_React$Component) {
		_inherits(ClientLists, _React$Component);

		function ClientLists() {
			_classCallCheck(this, ClientLists);

			_get(Object.getPrototypeOf(ClientLists.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(ClientLists, [{
			key: 'render',
			value: function render() {
				var _this = this;
				...
				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(_Charts2['default'], { contacts: this.props.contacts, headers: this.props.headers }),
					_react2['default'].createElement(
						'table',
						{ width: '100%' },
						_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'tbody',
							null,
							this.props.contacts.map(function (obj) {
								return _react2['default'].createElement(
									'tr',
									{ className: 'row-tb', key: obj._id },
									_this.props.headers.map(function (hobj) {
										var comp = hobj.header;
										return _react2['default'].createElement(
											'td',
											{ key: hobj._id },
											obj[comp]
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Charts = (function (_React$Component) {
		...
		function Charts() {
			...
			_get(Object.getPrototypeOf(Charts.prototype), 'constructor', this).call(this);
			this.state = {
				xlinechrtval: ''
			};
		}
		...
		_createClass(Charts, [{
			key: 'updateXvalue',
			value: function updateXvalue() {
				var selectedVal = (0, _jquery2['default'])('#line_charts option:selected').val();
				this.setState({
			...
			value: function render() {
				...
				this.props.headers.map(function (obj) {
					...
					var colmval = data.reduce(function (result, current) {
				...
				var passKey = false;
				var keyName = '';
				var headerNum = this.props.headers.length;
				var i = 1;
				...
				if (passKey == true) {
					...
					(function () {
						...
						_jquery2['default'].each(groups[keyName], function (i, v) {
							labels.push(i);
						...
						var MaxBar = Math.max.apply(Math, values);
						var MinBar = Math.min.apply(Math, values);
						if (MinBar > 0) {
							MinBar = 0;
						}
						var barOptions = {
						...
						BarChart = new Chartist.Bar('.ct-chart', barData, barOptions);
						...
						PieChart = new Chartist.Pie('.ct-piechart', pieData, pieOptions, PieResponsiveOptions);
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'div',
						{ className: 'row chart-dashboard' },
						_react2['default'].createElement(
							'div',
							{ className: 'col-md-5' },
							_react2['default'].createElement('div', { className: 'ct-chart ct-perfect-fourth' })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'col-md-5' },
							_react2['default'].createElement('div', { className: 'ct-piechart' })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'col-md-2' },
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									'select',
									{ id: 'line_charts', className: 'form-control', value: keyName, onChange: this.updateXvalue.bind(this) },
									this.props.headers.map(function (obj) {
										return _react2['default'].createElement(
											'option',
											{ key: obj._id, value: obj.header },
